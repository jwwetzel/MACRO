...
**Selection rule (science rows).** Canonical error-free Light frames of the five CVs in photometric filters only (grisms, 'empty', 'W', '6' excluded) — the strategy's canonical accounting rule, widened from rawimage-only to all canonical trees so the iKon-tree VV Pup/YZ Cnc/ST LMi frames stage too.
...
**This build (S0c v1.0 (2026-08-18) @ 2026-08-18T15:25Z):** 8,726 science rows +
4,768 calibration rows.
